...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["respectedfx.com", "www.respectedfx.com", "respectedfx.respectedfx.com", "respectedfx.yabgbot.online"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Respected FX <noreply@respectedfx.com>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa: F405
    {"url": "https://respectedfx.com", "description": "Production server"},
]
# Your stuff...
# ------------------------------------------------------------------------------
